        ...
        <header class="py-5 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">Bienvenido a mi Blog</h1>
                    <p class="lead mb-0">Este blog va dirigido a cursos de programación</p>
                </div>
            </div>
        </header>
        <!-- Page content-->
                ...
                <div class="col-lg-8">
                    ...
                    <nav aria-label="Pagination">
                        ...
                        <ul class="pagination justify-content-center my-4">
                            <li class="page-item"><a class="page-link me-2" href="#">Página 1</a></li>
                            <!-- <li class="page-item active" aria-current="page"><a class="page-link" href="#!">1</a></li>
                            <li class="page-item"><a class="page-link" href="#!">2</a></li>
                            <li class="page-item"><a class="page-link" href="#!">3</a></li>
                            <li class="page-item disabled"><a class="page-link" href="#!">...</a></li>
                            <li class="page-item"><a class="page-link" href="#!">15</a></li> -->
                            <li class="page-item"><a class="page-link ms-2" href="#!">Página 2</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- Side widgets-->
