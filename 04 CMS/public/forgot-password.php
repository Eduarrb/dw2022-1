                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post">
                                        ...
                                        <input type="submit" value="Restablecer" class="btn btn-primary btn-user btn-block" name="recover">
                                        <input type="hidden" class="hide" name="user_token" value="<?php echo token_generator(); ?>">
                                    </form>
                                    <hr>
                                    <div class="text-center">
